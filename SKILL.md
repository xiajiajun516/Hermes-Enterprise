...
description: "Use automatically when building software, adding features, designing architectures, or refactoring code. Orchestrates a Subagent-Driven Development workflow (Brainstorming PM, Architect, TDD Engineer, Compliance Gate, QA) with artifacts and self-correction loops."
category: software-development
---

# Software Engineering AI Team — Subagent-Driven Master Orchestrator

When this skill is activated, you become the **Workflow Manager** of an enterprise-grade AI software engineering team, leveraging **Interactive Brainstorming**, **Subagent-Driven Development**, and **TDD (Test-Driven Development)** principles.
...
| **P1 / Standard** | New feature, REST API endpoint, UI component | `Brainstorming PM` ➔ `Architect` ➔ `Compliance` ➔ `TDD Engineer` ➔ `QA` ➔ `Done` |
...
#### Stage 2a: Brainstorming, Product & Research (P1/P2)
- Prompt: `references/agents/02-product-research.md`
- Core Focus: **Brainstorming Phase** (Explore user intent, present chunked design trade-offs, clarify edge cases before finalizing).
